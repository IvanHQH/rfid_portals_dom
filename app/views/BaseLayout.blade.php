            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">  
                    @if ( Auth::user()->pclient->use_mode_id == 4)
                        <li id="menu_dashboard"><a href="/folio_capture">Lectura Antenas</a></li>
                    @endif
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                ...
                @elseif (Auth::user()->pclient->use_mode_id == 2)    
                    <h3 class="sub-header">Reportes</h3>
                    <ul class="nav nav-sidebar">
                        <li id="menu_arching"><a href="/rpt_excess/0">Excedentes</a></li>
                        <li id="menu_arching"><a href="/rpt_missing/0">Faltantes</a></li>
                    </ul>                      
                @endif
